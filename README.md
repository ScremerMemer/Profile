...
<div align="center">
  <div style="display: flex; justify-content: center; align-items: start; gap: 30px; margin: 40px 0; padding: 20px; background: rgba(27, 27, 27, 0.4); border-radius: 10px; backdrop-filter: blur(10px);">
